...
var POSITIONS: Dictionary[String, KeyFrameDataList] = {
  "down": KeyFrameDataList.new([
    KeyFrameData.new(Vector2(-4.1, 1.7), MathUtil.degrees_to_radians(-135)),
    KeyFrameData.new(Vector2(0.5, 4.6), MathUtil.degrees_to_radians(-180)),
    KeyFrameData.new(Vector2(5.1, 7.5), MathUtil.degrees_to_radians(-225)),
    KeyFrameData.new(Vector2(5.1, 7.5), MathUtil.degrees_to_radians(-225)),
    KeyFrameData.new(Vector2(5.1, 7.5), MathUtil.degrees_to_radians(-225)),
    KeyFrameData.new(Vector2(5.1, 7.5), MathUtil.degrees_to_radians(-225)),
    KeyFrameData.new(Vector2(5.1, 7.5), MathUtil.degrees_to_radians(-225)),
  ...
  "left": KeyFrameDataList.new([
    KeyFrameData.new(Vector2(0, -6.5), MathUtil.degrees_to_radians(-45)),
    KeyFrameData.new(Vector2(-3.05, -2.4), MathUtil.degrees_to_radians(-90)),
    KeyFrameData.new(Vector2(-6.1, 1.7), MathUtil.degrees_to_radians(-135)),
    KeyFrameData.new(Vector2(-6.1, 1.7), MathUtil.degrees_to_radians(-135)),
    KeyFrameData.new(Vector2(-6.1, 1.7), MathUtil.degrees_to_radians(-135)),
    KeyFrameData.new(Vector2(-6.1, 1.7), MathUtil.degrees_to_radians(-135)),
    KeyFrameData.new(Vector2(-6.1, 1.7), MathUtil.degrees_to_radians(-135)),
  ...
  "up": KeyFrameDataList.new([
    KeyFrameData.new(Vector2(4.1, -1.7), MathUtil.degrees_to_radians(45)),
    KeyFrameData.new(Vector2(-0.5, -4.6), MathUtil.degrees_to_radians(0)),
    KeyFrameData.new(Vector2(-5.1, -7.5), MathUtil.degrees_to_radians(-45)),
    KeyFrameData.new(Vector2(-5.1, -7.5), MathUtil.degrees_to_radians(-45)),
    KeyFrameData.new(Vector2(-5.1, -7.5), MathUtil.degrees_to_radians(-45)),
    KeyFrameData.new(Vector2(-5.1, -7.5), MathUtil.degrees_to_radians(-45)),
    KeyFrameData.new(Vector2(-5.1, -7.5), MathUtil.degrees_to_radians(-45)),
